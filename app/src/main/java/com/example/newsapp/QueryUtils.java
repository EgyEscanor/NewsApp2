    ...
    private static List<News> extractFeatureFromJson(String newsJSON) throws JSONException {
        ...
        try {
            ...
            for (int i = 0; i < newsArray.length(); i++) {
                ...
                publishedAt = publishedAt.replaceAll("[a-zA-z]"," ");


                // Create a new {@link News} object with the title, author, publishedAt,
                // and url from the JSON response.
                 news.add(new News(title,url,section,publishedAt,author));
